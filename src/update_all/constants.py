...
supporter_plus_patrons: Final[tuple[str,...]] = ('Alex Frégeau', 'Barry Tomkinson', 'Filip Kindt', 'musicisfun15', 'Thomas Williams')
...
FILE_cifs_mount_sh: Final[str] = 'Scripts/cifs_mount.sh'
...
FOLDER_mame: Final[str] = 'games/mame'
...
FILE_coinopkey: Final[str] = 'games/mame/coinopkey.zip'
FILE_coinopkey_alt: Final[str] = '_Arcade/mame/coinopkey.zip'
FILE_coinopkey_md5: Final[str] = 'Scripts/.config/update_all/coinopkey.md5'
COINOPKEY_ENTRY_NAME: Final[str] = 'coinop.key'
...
FILE_MiSTer_ini_update_all_backup: Final[str] = '.MiSTer.ini.update_all.bak'
FILE_lastcore_dat: Final[str] = 'config/lastcore.dat'
...
DOWNLOADER_OUTPUT_LTSV: Final[str] = 'dlp1-ltsv'
...
KENV_LAUNCH_ORIGIN_ID: Final[str] = 'LAUNCH_ORIGIN_ID'
...
UPDATE_ALL_VERSION: Final[str] = "2.11"
...
DOWNLOADER_URL: Final[str] = "https://raw.githubusercontent.com/MiSTer-devel/Distribution_MiSTer/refs/heads/main/Scripts/.config/downloader/downloader_latest.zip"
...
OVERSCAN_PRESETS: Final[dict[str, tuple[int, int]]] = {'none': (0, 0), 'small': (2, 1), 'medium': (4, 2)}
