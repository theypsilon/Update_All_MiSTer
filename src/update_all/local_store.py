...
class LocalStore:
    ...
    def set_chipster6502_artwork_dbs_general_selector(self, value: bool) -> None:
        self.generic_set('chipster6502_artwork_dbs_general_selector', value)

    def get_chipster6502_artwork_dbs_general_selector(self) -> bool:
        return self._props['chipster6502_artwork_dbs_general_selector']
    def set_chipster6502_artwork_default_style(self, value: str) -> None:
        self.generic_set('chipster6502_artwork_default_style', value)

    def get_chipster6502_artwork_default_style(self) -> str:
        return self._props['chipster6502_artwork_default_style']

    def set_chipster6502_artwork_db_styles(self, value: Dict[str, str]) -> None:
        self.generic_set('chipster6502_artwork_db_styles', value)

    def get_chipster6502_artwork_db_styles(self) -> Dict[str, str]:
        return self._props['chipster6502_artwork_db_styles']
