...
class AllDBs:
    def __init__(self):
        ...
        # UNOFFICIAL SCRIPTS
        self.MISTER_MONITOR = Database(db_id='chipster6502/MiSTer_monitor_DB', db_url='https://raw.githubusercontent.com/chipster6502/MiSTer_monitor_DB/db/db.json.zip', title='MiSTer Monitor')
        ...
        self.MANUALSDB_GAMEDOTCOM = Database(db_id='ajgowans/manualsdb-gamedotcom', db_url='https://raw.githubusercontent.com/ajgowans/manualsdb-gamedotcom/db/db.json.zip', title='Game.com Manuals')
        ...
        self.MANUALSDB_POCKETSTATION = Database(db_id='ajgowans/manualsdb-pocketstation', db_url='https://raw.githubusercontent.com/ajgowans/manualsdb-pocketstation/db/db.json.zip', title='PocketStation Manuals')
