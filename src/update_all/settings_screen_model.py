...
def _try_toggle_with_user_dependency(
        variable, title, dependency_instructions, enable_effects=(), when_enabled=None, alert_level=None):
    ...
    return [
        {
            ...
            "false": [{
                ...
                **({"alert_level": alert_level} if alert_level is not None else {}),
    ...
    "items": {
                    ...
                    "actions": {"uninstall": uninstall_db_action_for_id("MultiDatabases/diablo", "Diablo MiSTer"),
                        "ok": _try_toggle_with_user_dependency(
                            ...
                            [
                                ...
                                " ",
                                "Copy DIABDAT.MPQ from your own Diablo installation to:",
                                "games/Diablo/",
                        ...
                        "info": [{
                            ...
                            "text": [
                                ...
                                "You can play the full Diablo and Hellfire campaigns with your own game data.",
                                " ",
                                "You can launch Diablo and Hellfire from MiSTer's Other folder.",
        ...
        "tools_and_scripts_menu": {
            ...
            "variables": {
                ...
                "MultiDatabases/shmup-deck": {"group": "db", "default": "false", "values": ["false", "true"]},
            ...
            "entries": [
                    ...
                    "actions": {
                        ...
                        "ok": _try_toggle_with_user_dependency(
                            ...
                            [
                                ...
                                " ",
                                "WARNING: cifs_mount.sh and cifs_umount.sh are overwrite protected.",
                                "This means a script already installed on your MiSTer is never replaced, so it stops receiving new versions.",
                                "To get a new version, delete the script and run Update All again. Settings edited inside the script get lost.",
                                "Updates never touch Scripts/cifs_mount.ini, so settings saved there are kept.",
                                " ",
                ...
                {
                    "title": "# Shmup Deck",
                    "description": "{MultiDatabases/shmup-deck:enabled} Launch shmups from your phone",
                    "actions": {
                        "uninstall": uninstall_db_action_for_id("MultiDatabases/shmup-deck", "Shmup Deck"),
                        "ok": _try_toggle_with_user_dependency(
                            "MultiDatabases/shmup-deck",
                            "Shmup Deck",
                            [
                                "Shmup Deck is a flyer-wall launcher for shoot 'em ups, served from your MiSTer to your phone.",
                                "Your MiSTer must be connected to the same network as your phone.",
                                " ",
                                "WARNING: Shmup Deck keeps a runtime on at all times on MiSTer's ARM processor, using about 25 MB of the ~500 MB of RAM available to Linux.",
                                "This can affect the performance of other programs and even cores.",
                                " ",
                        ...
                        "info": [{
                            ...
                            "text": [
                                ...
                                "Your MiSTer must be connected to the same network as your phone.",
                                " ",
                                "Enabling this database installs the Shmup Deck service, its web app, and its launcher.",
                                "You can browse 178 arcade shooters as a flyer wall on your phone and tap one to load it on your MiSTer, with shared favourites, play statistics, and a checklist of the MRAs, cores and ROM zips each game still needs.",
                                " ",
                                "Run the shmup_deck script once from MiSTer's Scripts folder to start the service and register it at boot, then open http://shmupdeck.local on your phone.",
                                " ",
                                "Maintainer: searchsolved",
