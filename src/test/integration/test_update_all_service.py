...
from update_all.constants import FILE_mister_downloader_needs_reboot, UPDATE_ALL_LAUNCHER_PATH, UPDATE_ALL_LAUNCHER_MD5
...
def tester(files=None, folders=None, config: Config = None, store: LocalStore = None):
    ...
    return UpdateAllServiceTester(
        environment_setup=EnvironmentSetupStub(),
