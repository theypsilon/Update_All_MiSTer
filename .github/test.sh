...
WORK_NEW_PATH="${FAKE_MEDIA_FAT}/Scripts/.config/update_all"
...
ARCADE_ORGANIZER_INSTALLED_NAMES_TXT="${FAKE_MEDIA_FAT}/Scripts/.config/arcade-organizer/installed_names.txt"
...
CONFIG_FOLDER_PATH="${FAKE_MEDIA_FAT}/Scripts/.config"
MISTER_INI_PATH="${FAKE_MEDIA_FAT}/MiSTer.ini"
NAMES_TXT_PATH="${FAKE_MEDIA_FAT}/names.txt"
USBMOUNT_CONF_PATH="${FAKE_MEDIA_FAT}/usbmount.conf"
USBMOUNT_CONF_TMP="${FAKE_MEDIA_FAT}/tmp_usbmount.conf"
